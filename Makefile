...
#-----------------------------------------------------------------------------
vendor_modify_jars := com.qti.dpmframework framework qti-telephony-common services telephony-common wifi-service org.mokee.platform
...
override_property += \
    ro.flyme.romer=Jess \
    ro.product.model_romer=gemini_Jess
